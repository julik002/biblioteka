...
"color: rgb(255, 71, 41);")
        ...
        self.pushButton__app = QtWidgets.QPushButton(self.frame_2)
        self.pushButton__app.setGeometry(QtCore.QRect(40, 120, 181, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.pushButton__app.setFont(font)
        self.pushButton__app.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"color: rgb(255, 71, 41);")
        self.pushButton__app.setObjectName("pushButton__app")
...
"color: rgb(0, 37, 255);")
    ...
    def retranslateUi(self, CatListWindow):
        ...
        self.pushButton__app.setText(_translate("CatListWindow", "Добавить"))
